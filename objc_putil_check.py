        ...
        for f in dirs:
            ...
            if os.path.isdir(fi_d):
                ...
                if self.file_extension(f) == ".strings":
                    (status, output) = subprocess.getstatusoutput('plutil ' + fi_d)
...
if __name__ == '__main__':
    ...
    # # 报告文件名称
    # report_file = "/Users/haru.feng/Downloads/localizable_repo.txt"
    ...
    # 多语言管理对象
    manager = LocalizableManager("/Users/haru.feng/Documents/SourceCode/release-client-5.15.x/mac-client/Zoom/Zoom/Zoom", "/Users/haru.feng/Downloads/localizable_repo.txt")
